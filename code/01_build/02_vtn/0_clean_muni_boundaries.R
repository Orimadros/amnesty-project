...
RAW_DIR  <- here("data", "input", "muni_division_2015")
LAYER    <- "BRMUE250GC_SIR"
CLEAN_FN <- here("data", "clean", "muni_division_2015.Rdata")
dir.create(dirname(CLEAN_FN), recursive = TRUE, showWarnings = FALSE)
